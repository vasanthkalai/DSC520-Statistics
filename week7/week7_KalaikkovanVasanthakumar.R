...
#Use R to calculate the covariance of the Survey variables and provide an explanation of 
...
#Answer - Time Reading and time TV has a negative correlation
